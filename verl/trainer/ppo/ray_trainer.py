        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # Default None in case we skip reward computation in PCSD mode
                    ...
                    if not use_pcsd:
                        ...
                        # Privileged KD: build teacher sequences and update actor with reverse-KL
                        with marked_timer("update_actor", timing_raw, color="red"):
                            responses = batch.batch["responses"]
                            resp_len = responses.shape[1]
                            # Use response attention mask from generated attention mask tail
                            resp_attn_mask = batch.batch["attention_mask"][:, -resp_len:]
                            ...
                            teacher_attention_mask = torch.cat((teacher_prompt_mask, resp_attn_mask), dim=1)
